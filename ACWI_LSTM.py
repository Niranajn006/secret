...
#    pre_en_train = pre_en_train.reset_index(inplace=True)
#    pre_en_train = pre_en_train.dropna(axis=0, inplace=False)
...
if __name__ == '__main__':
    ...
    raw_df = get_data(r'D:\Projects\Data\Mkt timing.xlsx', 'Level_lag', 'A:K')
